...
#------------------------------------------------------------------------------
# PROGRAM: lat_gmst_counts_ssim_2_pkl.py
#------------------------------------------------------------------------------
# Version 0.1
# 5 March, 2023
# Michael Taylor
...
nc_file = 'DATA/glosat-lat/GloSATLAT_stations_gridded.nc'
nc_var = 'tas_median'
...
#----------------------------------------------------------------------------
# LOAD: GloSAT stations gridded netCDF
#----------------------------------------------------------------------------
...
df_gmst_lat = pd.DataFrame({ 'gmst':gmst_vec }, index=t_vec)
df_count_lat = pd.DataFrame({ 'count':count_vec }, index=t_vec)
df_ssim_lat = pd.DataFrame({ 'ssim':ssim_vec }, index=t_vec)

#----------------------------------------------------------------------------
# SAVE: GMST, count and SSIM timeseries to .pkl
#----------------------------------------------------------------------------

df_gmst_lat.to_pickle( 'df_gmst_lat.pkl', compression='bz2' )
df_count_lat.to_pickle( 'df_count_lat.pkl', compression='bz2' )
df_ssim_lat.to_pickle( 'df_ssim_lat.pkl', compression='bz2' )
