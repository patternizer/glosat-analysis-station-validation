...
#------------------------------------------------------------------------------
# PROGRAM: mat_gmst_counts_ssim_2_pkl.py
#------------------------------------------------------------------------------
# Version 0.1
# 5 March, 2023
# Michael Taylor
...
#nc_file = 'DATA/glosat-mat/GloSATMAT_2.4.0.0_anomaly_ensmean_b1961_1990.nc'
nc_file = 'DATA/glosat-mat/GloSATMAT_2.4.0.0_anomaly_b1961_1990.nc'
nc_var = 't2m_anomaly'
...
df_gmst_mat = pd.DataFrame({ 'gmst':gmst_vec }, index=t_vec)
df_count_mat = pd.DataFrame({ 'count':count_vec }, index=t_vec)
df_ssim_mat = pd.DataFrame({ 'ssim':ssim_vec }, index=t_vec)

#----------------------------------------------------------------------------
# SAVE: GMST, count and SSIM timeseries to .pkl
#----------------------------------------------------------------------------

df_gmst_mat.to_pickle( 'df_gmst_mat.pkl', compression='bz2' )
df_count_mat.to_pickle( 'df_count_mat.pkl', compression='bz2' )
df_ssim_mat.to_pickle( 'df_ssim_mat.pkl', compression='bz2' )
